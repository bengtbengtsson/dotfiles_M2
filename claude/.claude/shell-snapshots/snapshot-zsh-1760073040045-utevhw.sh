...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/opt/homebrew/Caskroom/claude-code/2.0.13/claude --ripgrep'
fi
export PATH=/Users/ben/.nvm/versions/node/v20.18.2/bin\:/Users/ben/.sdkman/candidates/java/current/bin\:/Users/ben/local/lua-5.1/bin/\:/opt/homebrew/opt/make/libexec/gnubin\:/opt/homebrew/bin\:/Users/ben/dotfiles/scripts\:/opt/homebrew/bin\:/opt/homebrew/sbin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Library/TeX/texbin\:/usr/local/share/dotnet\:/Users/ben/.dotnet/tools\:/Users/ben/.cargo/bin\:/Users/ben/.local/bin\:/Applications/Ghostty.app/Contents/MacOS\:/Users/ben/Library/Android/sdk/platform-tools
